...
const YouTubeTV = ({ videoId }: { videoId: string }) => {
  return (
    <div className="relative w-full max-w-[1000px] h-[800px]">
      <div className="relative bg-[#2a2a2a] h-[800px] p-6 rounded-[3.5rem] shadow-[0_0_60px_rgba(0,0,0,0.7),inset_0_2px_10px_rgba(255,255,255,0.1)] border-b-[10px] border-black">
        
        <div className="relative w-full h-[680px] bg-black rounded-[2.5rem] overflow-hidden aspect-[4/3] border-[15px] border-[#1a1a1a] shadow-inner">
