...
const Sidebar = () => {
  ...
  return (
    <section className="w-60 flex flex-col items-center h-screen px-8 -mt-2 flex-none">
      ...
      <nav className="w-full flex-grow">
        <ul>
          <li className="mb-4">
            ...
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/home _icon.png" alt="" width={24} height={24} className="mb-2" />
          ...
          <li className="mb-4">
            ...
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/team_icon.png" alt="" width={24} height={24} className="mb-1" />
          ...
          <li className="mb-4">
            ...
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/video_icon.png" alt="" width={24} height={24} className="mb-1" />
          ...
          <li className="mb-4">
            ...
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/build_icon.png" alt="" width={24} height={24} className="mb-1" />
          ...
          <li className="mb-4">
            ...
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/user_icon1.png" alt="" width={24} height={24} className="mb-2" />
          ...
          <li className="mb-4">
            ...
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/settings_icon.png" alt="" width={24} height={24} className="mb-1" />
