...
import ChineseChess from '@/component/games/ChineseChess';
import { useState } from 'react';
import useTrans from '@/hooks/useTrans';

type GameType = 'list' | 'snake' | 'pacman' | 'chess';
...
export default function GamePage() {
  ...
  const renderGame = () => {
    switch (currentGame) {
      ...
      case 'chess': return <ChineseChess onGoBack={() => setCurrentGame('list')} />;
      case 'list':
      default:
        return (
